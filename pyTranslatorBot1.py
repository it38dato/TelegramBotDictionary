...
def start(message):
    ...
    bot.send_message(message.chat.id, 'Привет, {0.first_name}! Я тестовый бот. Выбери программу, которую ты хочешь выполнить'.format(message.from_user), reply_markup = markup)
